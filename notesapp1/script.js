...
// Pembaruan logika JavaScript aplikasi catatan
...
// Tambahkan setiap catatan dari data dummy ke dalam DOM
...
titleInput.addEventListener('input', function() {
  toggleInputValidity(this);
  toggleAddNoteButton();
});

// Tambahkan event listener untuk input isi
bodyInput.addEventListener('input', function() {
  toggleInputValidity(this);
  toggleAddNoteButton();
});

// Fungsi untuk memeriksa dan menambah atau menghapus kelas invalid
